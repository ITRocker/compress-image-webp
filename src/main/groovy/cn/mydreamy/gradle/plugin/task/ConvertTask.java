...
import cn.mydreamy.gradle.plugin.WebPAndroidPlugin;
...
//                        } else {
                        dstFilePath = SourceUtils.webPResPath + parent.getName() + "/" + dstName;
...
//                        }
                        ...
                        try {
                            ...
                            //备份图片
                            moveFileTo(srcFilePath, SourceUtils.pngBackupResPath + parent.getName() + "/" + srcName);
                        } catch (IOException e) {
                            Logger.i("convert failed: " + srcFilePath);
                        }
                    }
    ...
    public static class ConfigAction implements Action<ConvertTask> {
        ...
        public ConfigAction(Project project, String cwebpPath, boolean useOriPng, int quality) {
        ...
        public void execute(ConvertTask convertTask) {
            ...
            convertTask.useOriPng = useOriPng;
        ...
        public static Collection<File> getAndroidResDirectories(Project project) {
